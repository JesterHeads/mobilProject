...
// module
exports.push([module.i, "\n.questionButton[data-v-45ba5ed4]{\n\tborder : 10px solid blue;\n\tborder-radius : 50%\n}\n", ""]);
...
// module
exports.push([module.i, "\n.title-label[data-v-67410f3a]{\n    margin : 30px 20px;\n    text-align : center;\n}\n.label[data-v-67410f3a]{\n    margin : 0 20px;\n    text-align : center;\n}\n.myButton[data-v-67410f3a]{\n    width : 40%;\n    border-radius: 50%\n}\n", ""]);
...
var render = function() {
  ...
  return _c(
    ...
    { staticClass: "page" },
    [
      _c("ActionBar", { attrs: { title: "AlterPicture" } }),
      _c(
        "StackLayout",
        [
          _c("Button", {
      ...
      _c(
        ...
        [
          _c("Label", {
            ...
            attrs: { text: "Welcome in our app to alter picture." }
          }),
          _c("Label", {
            staticClass: "title-label",
            attrs: {
              text:
                "This is an app developped as a project for our course in Web Technologies for mobility, in other word, learning to develop application for mobil devices.",
              textWrap: "true"
            }
          }),
          _c("Button", {
            staticClass: "btn btn-primary myButton",
            attrs: { text: "Close", marginTop: "20" },
            on: {
              tap: function($event) {
                _vm.$goTo("app", _vm.navOptions)
              }
            }
          })
        ],
...
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./router.js");
...
nativescript_vue__WEBPACK_IMPORTED_MODULE_0___default.a.prototype.$router = _router__WEBPACK_IMPORTED_MODULE_2__["default"];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_Home__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./components/Home.vue");
